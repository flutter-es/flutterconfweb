...
Bienvenido a la aplicación oficial de FlutterConf Latam (“la App”, “nosotros”, “nuestro”). Al utilizar esta aplicación móvil, aceptas los siguientes Términos y Condiciones.

Si no estás de acuerdo con alguno de ellos, por favor no uses esta App.
...
* Estos datos no pueden ser modificados por el usuario para asegurar la transparencia del evento.
...
* Al hacerlo, aceptas que tus redes puedan ser visibles y buscadas por otros usuarios dentro de la App.
* FlutterConf Latam no se responsabiliza del uso que terceros hagan de dicha información fuera de la App.
...
* Recopilamos los siguientes datos personales: nombre, apellidos, foto de perfil (de Google o Apple), país de origen y, de manera opcional, tus redes sociales.
* Usamos esta información para fines operativos del evento, identificación dentro de la App y networking entre usuarios.
...
Al usar esta App, reconoces haber leído y aceptado estos Términos.