...
* Unique identifiers (e.g., push token, device ID)
* Language, location (non-precise), and time zone
...
* Display schedules, speakers, and session content
* Personalize your app experience and allow bookmarking
* Send relevant event notifications (if enabled)
* Monitor performance and fix technical issues
* Ensure safety, prevent misuse, and improve the app
...
* **Google Firebase** for analytics, crash reporting, and messaging
* Cloud infrastructure providers securely hosting backend services
...
* Routine system audits and security reviews
