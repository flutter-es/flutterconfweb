          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(metadataItem.label, style: const TextStyle(color: Colors.black)),
              ),
              Container(
                ...
                margin: const EdgeInsets.only(right: FlutterConfLatamStyles.smallSize),
                child: Text(metadataItem.value,
                style: TextStyle(
