...
import 'package:flutter_conf_latam/features/contact/presentation/responsiveness/contact_page_responsive_config.dart';
...
class ContactPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final uiConfig = ContactPageResponsiveConfig.getContactPageResponsiveConfig(
      context,
    );
                ...
                [
                      ...
                      MouseRegion(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Utils.launchUrlLink(
                              'mailto:${Constants.conferenceEmail}',
                            );
                          },
                          child: Container(
