...
import 'package:flutter_conf_latam/features/speakers/presentation/widgets/speaker_badge.dart';
import 'package:flutter_conf_latam/features/speakers/presentation/widgets/speaker_content_window.dart';
      ...
      child: speakers.when(
        data: (speakersList) {
          return Wrap(
            ...
            children:
                [
                      for (final speaker in speakersList.where(
                        (s) => s.display! == true,
                      ))
                        SpeakerBadge(
                          speaker: speaker,
