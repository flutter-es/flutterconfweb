...
class SpeakerBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: 300,
      child: Padding(padding: FlutterConfLatamStyles.mediumPadding,
        child: Column(
          ...
          children: [
            ...
            Text(speaker.name!, style: FlutterConfLatamStyles.h6, textAlign: TextAlign.center,),
            FlutterConfLatamStyles.smallVGap,
              ...
              children: [
                for(var social in speaker.socialMediaLinks!)
                  IconButton(
                    ...
                    icon: Icon(FlutterConfLatamIcons.getIconFromEnum(social.type)
                  ),
                ),
              ]
            )
